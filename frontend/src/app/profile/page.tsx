  ...
  return (
    <>
      ...
      <div className="mt-[64px] xs:ml-0 md:ml-[250px] w-full p-6">
        <h1 className="mb-5 text-2xl font-bold text-black">Profile Management</h1>
        <div className="flex w-full items-center gap-5">
          <div>
            <Image src="/profile-avatar.svg" alt="Profile Avatar" className="w-full" width={91} height={91} />
          </div>
        ...
        <div className="mt-8 flex w-4/5 flex-col gap-5 rounded-md bg-white p-6">
          <div className="flex flex-col gap-6 md:flex-row">
            <div className="flex w-full flex-col">
              <label htmlFor="full-name" className="mb-2 text-sm font-medium text-gray-700">
                Full Name
              </label>
              <input
                type="text"
            ...
            <div className="flex w-full flex-col">
              <label htmlFor="nick-name" className="mb-2 text-sm font-medium text-gray-700">
                Nick Name
              </label>
              <input
                type="text"
          ...
          <div className="flex flex-col gap-6 md:flex-row">
            <div className="flex w-full flex-col">
              <label htmlFor="language" className="mb-2 text-sm font-medium text-gray-700">
                Language
              </label>
              <select
                id="language"
            ...
            <div className="flex w-full flex-col">
              <label htmlFor="time-zone" className="mb-2 text-sm font-medium text-gray-700">
                Time Zone
              </label>
              <select
                id="time-zone"
        ...
        <div className="mt-8">
          <h3 className="mb-3 ml-6 text-lg font-semibold text-gray-800">My Email Address</h3>
          <div className="flex flex-wrap items-center justify-between gap-3 rounded-md bg-white p-4">
            <div className="flex items-center gap-3">
              <div className="flex h-10 w-10 items-center justify-center rounded-full bg-purple-50">
                <Image src="/emailp.svg" alt="Email Icon" width={24} height={24} />
              </div>
              <div className="flex flex-col">
                <p className="text-sm font-medium text-gray-800">{userEmail}</p>
                <small className="mt-1 text-xs text-gray-500">1 month ago</small>
              </div>
            </div>
          </div>
