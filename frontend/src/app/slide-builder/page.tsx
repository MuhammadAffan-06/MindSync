...
import "./[presentationId]/slide-builder.css";
...
import SlideHeader from "@/app/components/slideEditor/slideHeader/slideHeader";
...
function SlideBuilder() {
  ...
  useEffect(() => {
    ...
    (async () => {
      const response = await apiRequest("/presentation/get", {
